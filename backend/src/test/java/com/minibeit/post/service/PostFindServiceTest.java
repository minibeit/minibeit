...
//        createdPost.create(KSchool, businessProfile, request.toPostDoDates(), thumbnail, files);
...
//        createdPost2.create(KSchool, businessProfile, request.toPostDoDates(), thumbnail, files);
...
//        createdPost3.create(KSchool, businessProfile, request.toPostDoDates(), thumbnail, files);
