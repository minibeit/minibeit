...
`GET /api/post/{postId}/exist/doDate/list`
...
요청 HTTP
include::{snippets}/post-myCompleted-list/http-request.adoc[]
include::{snippets}/post-myCompleted-list/request-parameters.adoc[]

성공 응답 HTTP
include::{snippets}/post-myCompleted-list/http-response.adoc[]
include::{snippets}/post-myCompleted-list/response-fields.adoc[]
