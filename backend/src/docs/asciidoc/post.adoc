...
요청 HTTP
include::{snippets}/post-create-info/request-body.adoc[]
...
=== 게시물 파일 추가
`POST /api/post/{postId}/files`

요청 HTTP

include::{snippets}/post-add-files/path-parameters.adoc[]
include::{snippets}/post-add-files/request-parts.adoc[]

성공 응답 HTTP
include::{snippets}/post-add-files/http-response.adoc[]
include::{snippets}/post-add-files/response-fields.adoc[]
...
`DELETE /api/rejectPost/{rejectPostId}`

요청 HTTP
include::{snippets}/rejectPost-deleteOne/http-request.adoc[]
include::{snippets}/rejectPost-deleteOne/path-parameters.adoc[]

성공 응답 HTTP
include::{snippets}/rejectPost-deleteOne/http-response.adoc[]
...
`POST /api/post/{postId}/date/{postDoDateId}/attend/change/{userId}`
...
=== 게시물에 해당하는 확정자 목록 날짜 기준으로 조회하기(실험모집하는 연구실)

`GET /api/post/{postId}/applicant/confirm/list`

요청 HTTP
include::{snippets}/post-applicant-confirm-list/http-request.adoc[]
include::{snippets}/post-applicant-confirm-list/path-parameters.adoc[]
include::{snippets}/post-applicant-confirm-list/request-parameters.adoc[]

성공 응답 HTTP
include::{snippets}/post-applicant-confirm-list/http-response.adoc[]
include::{snippets}/post-applicant-confirm-list/response-fields.adoc[]