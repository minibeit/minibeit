      ...
      >
        <S.AlertBox>
          <S.AlertContent>
            ...
            <div>
              <p>
                - 이 개인정보처리방침은 2021년 12월 1일부터 적용됩니다. <br />
                <br />
                **제1조(개인정보의 처리 목적) &lt; CLMOI &gt;
                ('[www.minibeit.com](http://www.minibeit.com/)'이하
                'minibeit')은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
                ...
                **제2조(개인정보의 처리 및 보유 기간)**
                <br />
                <br />
                ① &lt; CLMOI &gt; 은(는) 법령에 따른 개인정보 보유·이용기간 또는
                정보주체로부터 개인정보를 수집 시에 동의받은 개인정보
                보유·이용기간 내에서 개인정보를 처리·보유합니다.
                <br />
                ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다. 1와
                관련한 개인정보는 수집.이용에 관한 동의일로부터까지 위
                이용목적을 위하여 보유.이용됩니다.
                <br />
                보유근거 : 관련 법령
                <br />
                ...
                <br />　 3) 표시/광고에 관한 기록 : 6개월
                <br />
                <br />
                **제5조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)**
                <br />
                <br />
                ① 정보주체는 CLMOI에 대해 언제든지 개인정보
                열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
                <br />
                ② 제1항에 따른 권리 행사는CLMOI에 대해 「개인정보 보호법」
                시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
                통하여 하실 수 있으며 CLMOI은(는) 이에 대해 지체 없이
                조치하겠습니다.
                <br />
                ...
                없습니다.
                <br />
                ⑥ CLMOI은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
                ...
                **제6조(처리하는 개인정보의 항목 작성)**
                <br />
                <br />
                ① &lt; CLMOI &gt; 은(는) 다음의 개인정보 항목을 처리하고
                있습니다.
                <br />
                <br />
                1&lt; 홈페이지 회원가입 및 관리 &gt; <br />
                필수항목 : 이메일, 휴대전화번호, 자택주소, 비밀번호, 로그인ID,
                성별, 생년월일, 이름, 직업, 서비스 이용 기록, 접속 로그, 쿠키,
                접속 IP 정보
                <br />
                <br />
                2&lt; 재화 또는 서비스 제공 &gt; <br />
                ...
                **제7조(개인정보의 파기)**
                <br />
                <br />
                ① &lt; CLMOI &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성
                ...
                1. 파기절차
                <br />
                &lt; CLMOI &gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고,
                &lt; CLMOI &gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를
                파기합니다.
                <br />
                2. 파기방법
                <br />
                ...
                **제8조(개인정보의 안전성 확보 조치)**
                <br />
                <br />
                **&lt; CLMOI &gt; 은(는) 개인정보의 안전성 확보를 위해 다음과
                같은 조치를 취하고 있습니다.**
                <br />
                <br />
                ...
                **제9조(개인정보 자동 수집 장치의 설치?운영 및 거부에 관한
                ...
                <br />
                <br />
                ① CLMOI 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
                ...
                **제10조 (개인정보 보호책임자)**
                <br />
                <br />
                ① CLMOI 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
                ...
                <br />
                연락처 :010-4578-8266,
                [gotjddl7@gmail.com](mailto:gotjddl7@gmail.com),
                <br />
                ② 정보주체께서는 CLMOI 의 서비스(또는 사업)을 이용하시면서
                발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에
                관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
                있습니다. CLMOI 은(는) 정보주체의 문의에 대해 지체 없이 답변 및
                처리해드릴 것입니다.
                <br />
                <br />
                **제11조(개인정보 열람청구)**
                ...
                **정보주체는 ?개인정보 보호법? 제35조에 따른 개인정보의 열람
                ...
                <br />
                **&lt; CLMOI &gt; 은(는) 정보주체의 개인정보 열람청구가 신속하게
                처리되도록 노력하겠습니다.**
                <br />
                <br />
                ▶ 개인정보 열람청구 접수·처리 부서
